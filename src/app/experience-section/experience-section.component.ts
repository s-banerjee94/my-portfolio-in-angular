...
export class ExperienceSectionComponent implements OnInit {
  ...
  constructor() {
    ...
    //     color: '#fc5e6a',
    //     summary: `I worked as a Software Development Engineer on key modules for the flagship product Dzylo One.
    //     I developed a lead follow-up feature using Node.js, Kotlin (Ktor), and Angular, integrating MySQL
    //     and AWS DynamoDB for data handling and leveraging AWS SQS, EventBridge, and Lambda to automate follow-up
    //     reminders. Additionally, I implemented a task reviewer system that allowed manual selection of reviewers
    //     and enabled them to update review statuses, which dynamically updated the overall task status.`
    //   },
    //   {
